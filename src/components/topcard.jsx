...
export function TopCard(props) {
  ...
  return (
    <div className="topcard lg:w-[25vw] w-[42vw] border-y border-[#43613d] rounded-[10px]">
      ...
      <div className="mt-[1rem]">
        ...
        <div className="flex">
          {post.size1 ? <p onClick={() => {setsize(post.size1)}} className={`px-[0.2rem] text-center text-xs rounded-sm mt-[0.3rem] mb-[0.5rem] border font-bold ${size == post.size1 ? "bg-[#43613d] text-[#f7f0e4]" : ""}`}>{post.size1}</p> : ""}
          {post.size2 ? <p onClick={() => {setsize(post.size2)}} className={`px-[0.2rem] mx-[0.5rem] text-xs text-center rounded-sm mt-[0.3rem] mb-[0.5rem] border font-bold ${size == post.size2 ? "bg-[#43613d] text-[#f7f0e4]" : ""}`}>{post.size2}</p> : ""}
          {post.size3 ? <p onClick={() => {setsize(post.size3)}} className={`px-[0.2rem] text-center text-xs rounded-sm mt-[0.3rem] mb-[0.5rem] border font-bold ${size == post.size3 ? "bg-[#43613d] text-[#f7f0e4]" : ""}`}>{post.size3}</p> : ""}
        </div>
      </div>
      ...
      <div className="mx-[1rem] flex justify-center">
        <div
          className="p-[0.1rem] px-[1rem] rounded-sm mt-[1rem] mb-[0.5rem] bg-[#43613d]"
          onClick={() => {
            !user
              ? navigate("/Profile")
              : hasProductBeenSaved
        ...
        >
          {loadingCart ? (
            ...
            <p className="text-[#f7f0e4] font-bold text-sm">
